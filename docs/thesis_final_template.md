...
> **SUPERSEDED 2026-09-21** by `thesis_skeleton_v3_merged.md` (six chapters, results organised per research question). Kept for history. Carried forward unchanged: the global writing rules and the appendix A–D scope. No longer applying: the by-model Chapter-4 layout, the 5.6/5.7 placement, and the 47–54-page budget.
