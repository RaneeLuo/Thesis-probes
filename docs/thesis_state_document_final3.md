...
**Not started:** Probe 1 on TRUCE substrate; ChatTS (all probes; GPU session); Probe 3. Probe-2 EXECUTION is COMPLETE on CLaSP, floor, and TRACE (2026-08-13/14/15).
